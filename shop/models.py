...
class Clothes(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2)  # Price per day with decimals
...
class Rental(models.Model):
    ...
    rental_date = models.DateField(default=timezone.now)  # Date the user wants the cloth
